                    ...
                    <div class="panel-body">
                        ...
                        <div class="ibox-content">
                            <section class="status-wrap">
                                ...
                                <div class="p-3">
                                    <h4 class="text-default border-bottom pb-1">VŨ SANG <a class="text-default edit-icon" data-toggle="collapse" href="#collapse02" role="button" aria-expanded="false" aria-controls="collapse02"><i class="fa fa-edit ml-2"></i></a></h4>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="row">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-9">Chưa chọn</div>
                                            </div>
                                            <div class="row">
